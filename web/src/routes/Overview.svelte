    ...
    <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        <div class="rounded-sm border border-zinc-200 bg-white p-3">
            <div class="flex items-center justify-between gap-2">
                <p
                    class="text-xs font-medium uppercase tracking-normal text-zinc-500"
                >
                    Sources
                </p>
                <Database aria-hidden="true" class="text-zinc-500" size={17} />
            </div>
            <p class="mt-2 text-2xl font-semibold tabular-nums text-zinc-950">
        ...
        <div class="rounded-sm border border-zinc-200 bg-white p-3">
            ...
            <p class="mt-2 text-2xl font-semibold tabular-nums text-rose-700">
